    ...
    if (isset($_POST['save'])) {
        ...
        $query = "INSERT INTO `kullanici_tbl` (`ad_soyad`, `mail`, `sifre`) VALUES ('$ad_soyad', '$mail', '$sifre')";
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        // Eğer kullanıcı bilgisi varsa, kullanıcının adını session olarak sakla ve index.html sayfasına yönlendir.
        if ($stmt->rowCount() > 0) {
                            ...
                            <div class="card-body p-5 ">
                                ...
                                <div class="mb-md-5 mt-md-4 pb-5">
                                    ...
                                    <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                                        ...
                                        <div class="d-grid">
                                            <button class="btn btn-outline-light" type="submit" name="login">Giriş Yap</button><br><br>
                                            <button class="btn btn-block btn-outline-light"
                                                style="background-color: #dd4b39;" type="submit"><i
                                                    class="fab fa-google me-2"></i> Google ile giriş yap</button>
                                        </div>
                                    </form>
                                ...
                                <div class="text-center">
                                    ...
                                    <a href="#!" class="text-white-50 fw-bold" data-toggle="modal"
                                        data-target="#modal-default"> kaydol</a>
                                </div>
